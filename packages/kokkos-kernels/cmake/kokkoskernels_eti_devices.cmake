...
KOKKOSKERNELS_ADD_OPTION(
  ...
  OFF
  BOOL
  "Whether to create source files with shorter names as needed for Windows."
  "  Default: OFF"
)

IF(KOKKOSKERNELS_USE_SHORTNAMES)
  SET(INST_HOSTSP_VARNAME INST_HOSTSP)
ELSE()
  SET(INST_HOSTSP_VARNAME INST_MEMSPACE_HOSTSPACE)
ENDIF()
...
IF(KOKKOSKERNELS_INST_EXECSPACE_OPENMP AND KOKKOSKERNELS_${INST_HOSTSP_VARNAME})
...
IF(KOKKOSKERNELS_INST_EXECSPACE_PTHREAD AND KOKKOSKERNELS_${INST_HOSTSP_VARNAME})
...
IF(KOKKOSKERNELS_INST_EXECSPACE_SERIAL AND KOKKOSKERNELS_${INST_HOSTSP_VARNAME})
